...
export default factories.createCoreController('api::placement-partner.placement-partner' as any, ({ strapi }) => ({
  async find(ctx) {
  ...
  async create(ctx) {
    ...
    if (roleType !== 'institute_admin') {
      return ctx.forbidden('Only Institute Admin can create placement partners');
    }
  ...
  async update(ctx) {
    ...
    if (roleType !== 'institute_admin') {
      return ctx.forbidden('Only Institute Admin can update placement partners');
    }
  ...
  async delete(ctx) {
    ...
    if (roleType !== 'institute_admin') {
      return ctx.forbidden('Only Institute Admin can delete placement partners');
    }
